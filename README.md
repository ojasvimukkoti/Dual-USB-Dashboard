Example dashboard script that shows visualizations for ATP testing reports for Dual USBs at Amphenol PCD. Meant to highlight why the dual USB products were failing when ATP test was conducted. 
